...
const testimonials = [
  {
    text: "The user experience is phenomenal, and the support is always there to help. Highly recommended!",
    name: "Erica Wyatt",
  ...
  {
    text: "The integration process was seamless, and the performace improvemnts are beyond our expectations.",
    name: "Harry Bender",
