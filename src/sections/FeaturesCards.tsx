...
const cardData = [
  ...
  },
  {
    ...
    description:
      "Empower your applications with decentralized with data solutions, ensuring security and  transparency at every step",
    color: "lime",
  },
  {
    ...
    description:
      "Unlock the potential of next-gen smart contracts with our robust and scalable API, tailored for modern blockchains needs",
    color: "cyan",
  },
  {
