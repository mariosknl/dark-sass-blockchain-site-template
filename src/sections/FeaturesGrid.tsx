...
const listItems = [
  "Experience unparelleled security and scalability",
...
export const FeaturesGrid = () => {
  ...
  const { scrollYProgress: torusKnowScrollYProgress } = useScroll({
    target: torusKnotRef,
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                ...
                <p>
                  ...
                  create scalable, user-friendly dApps with low transcaction
