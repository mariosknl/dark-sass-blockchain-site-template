...
export const HeroSection = () => {
  ...
  const { scrollYProgress: turosScrollYProgress } = useScroll({
    target: cubeRef,
    offset: ["start end", "end start"],
  });
  ...
  const turosRotate = useTransform(turosScrollYProgress, [0, 1], [20, -20]);
